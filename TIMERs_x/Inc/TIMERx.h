...
//Definición de registros para temporizadores TIM2 y TIM8
typedef struct
{
...
bool TIMx_InternalCLK(TIM_HandlerDef * tim, uint32_t in_Freq, uint32_t out_Freq, float *duty, uint8_t numchannels);
